...
import { TextAlignButton } from "@/components/tiptap-ui/text-align";
  ...
  return (
    <>
      ...
      <ToolbarGroup>
        ...
        <MathematicsButton type="inline" />
        <MathematicsButton type="block" />
      </ToolbarGroup>
      <ToolbarSeparator />
      <ToolbarGroup>
...
export function SimpleEditor() {
  ...
  const editor = useEditor({
    ...
    extensions: [
      ...
      Math.configure({
        katexOptions: {
          throwOnError: false, // 不因LaTeX代码无效而抛出错误
          displayMode: false, // 由节点类型决定显示模式
        },
      }),
      Typography,
      Superscript,
